# Project Plan: JobHub
Created: 2026-05-25
Last Updated: 2026-06-04 (session 15)
...
- [x] TC7: Mobile responsive 375px — Fixes implemented commit `2327a4c` (chưa verify thực tế trên browser). CompareBar compact, modal max-h scroll, page padding p-4 sm:p-8, /jobs filter collapsible toggle.
...
**Stage 7 COMPLETE. Dự án đã đủ tính năng để bảo vệ đồ án.**

Các bước còn lại:
1. **Verify production** — Kiểm tra F6 (/u/slug public profile), F7 (compare bar + compare page), F8 (CV list) trên `https://job-hub-two.vercel.app`. Nếu Render không auto-deploy: Manual Deploy từ dashboard.
2. **Visual verify TC7** — Mở DevTools 375px, pass qua: /jobs (filter toggle), /candidate/applications (Kanban 2-col), /candidate/profile (modal scroll), CompareBar khi có 2–3 jobs.
3. **Demo script + Slide thuyết trình** — Chưa cần vội, còn nhiều thời gian trước bảo vệ.
