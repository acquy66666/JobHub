...
**Ưu tiên — Chuẩn bị bảo vệ đồ án:**
1. ✅ Verify `/admin/logs` — 19 bản ghi hiển thị, filter hoạt động (verified session 9)
2. ✅ Verify `/candidate/job-alerts` — alerts hiển thị đúng (verified session 9)
3. ✅ Verify `/admin/jobs` tab "⚠ Gắn cờ" — flagged jobs hiển thị (verified session 9)
4. ✅ Verify `/admin/reports` — 8 báo cáo hiển thị, review/dismiss hoạt động (verified session 9)
5. Chuẩn bị luồng demo 3 role đầy đủ cho bảo vệ đồ án
