# Project Plan: JobHub
Created: 2026-05-25
Last Updated: 2026-06-04 (session 17)
...
**Stage 7 + CV Builder COMPLETE. Dự án sẵn sàng bảo vệ đồ án.**

Việc cần làm tiếp theo:
1. **Verify CV Builder trên production** — Vào Vercel, kiểm tra `/candidate/cv/builder` gallery hiển thị đúng 10 mẫu, editor load profile, tải xuống PDF thành công.
2. **Demo script** — Chuẩn bị kịch bản demo 10–15 phút: login 3 role, apply job, employer review, admin duyệt, demo CV Builder.
3. **Slide thuyết trình** — Khi gần ngày bảo vệ.
4. **Seed data thêm** — Nếu cần data phong phú hơn (qua Supabase MCP).
