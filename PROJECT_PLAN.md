...
Status: Stage 5 ✅ COMPLETE | Stage 6 Nhóm 1 ✅ DONE | Stage 6 Nhóm 2 ✅ DONE | Stage 6 Nhóm 3 ✅ DONE | Stage 6 COMPLETE
...
**Stage 6 COMPLETE. Ưu tiên — Deploy + Verify toàn bộ:**
1. Push code → Vercel + Render tự redeploy (4 commits chưa push: Nhóm 2 cuối + Nhóm 3)
2. Verify Nhóm 2: báo cáo vi phạm, xuất CSV, LineChart, Match Score, Candidate Search
3. Verify Nhóm 3: `/admin/logs` hiển thị log sau khi duyệt/từ chối job, `/candidate/job-alerts` tạo + toggle, job flagged hiện badge ⚠ trong admin/jobs
4. Chuẩn bị bảo vệ đồ án: review luồng demo 3 role, test toàn bộ end-to-end
