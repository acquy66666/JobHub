...
**Session 23 (2026-06-04) — UI/UX Audit:** Subagent review toàn frontend. Phát hiện 10 vấn đề + 5 quick wins + 5 improvements lớn. **Điểm yếu chính:** (1) Employer Dashboard kém visual weight so với Candidate (thiếu HERO, thiếu skeleton, fetch `limit:100` bug số liệu), (2) Mobile hamburger label cứng "Dashboard" cả 2 layout, (3) Employer applications information density quá cao, không collapse, (4) Accessibility — gần như không có focus-visible ring trên toàn app, (5) Recharts không responsive mobile, (6) `/candidate/compare` thiếu empty state hướng dẫn, (7) CV Builder thumbnail overlay chỉ `group-hover` không accessible. **Quick wins ưu tiên trước demo:** QW-1 mobile header label động, QW-2 skeleton employer dashboard, QW-3 staleTime cho query, QW-4 focus-visible ring global, QW-5 empty state compare. Đặt làm **TASK ƯU TIÊN CAO NHẤT trước E10**.
